...
public:
	GuiMsgbox	(MSGBOX_TYPE type, char *title, char *msg, char *ok = NULL, char *cancel = NULL);
	~GuiMsgbox	(void);
...
extern int	GUI_msgbox	(MSGBOX_TYPE type, char *title, char *msg, char *ok = NULL, char *cancel = NULL);
