/* Based on original GPL Trolltech Code:
**
...
*/
ModelSanity::ModelSanity(QAbstractItemModel *_model, QObject *parent) : QObject(parent), model(_model), fetchingMore(false)
{
    Q_ASSERT(model);
...
*/
void ModelSanity::nonDestructiveBasicTest()
{
...
void ModelSanity::hasIndex()
{
    ...
    /* prevent compiler warnings */ DBG_UNREFERENCED_LOCAL_VARIABLE (columns);
 ...
 */
void ModelSanity::checkChildren(const QModelIndex &parent, int currentDepth)
{
...
void ModelSanity::data()
{
	...
	/* prevent compiler warnings */ DBG_UNREFERENCED_LOCAL_VARIABLE (alignment);
	...
	/* prevent compiler warnings */ DBG_UNREFERENCED_LOCAL_VARIABLE (state);
...
/*!
    ...
    \sa rowsInserted()
 */
void ModelSanity::rowsAboutToBeInserted(const QModelIndex &parent, int start, int end)
{
    Q_UNUSED(end);
    Changing c;
    c.parent = parent;
 ...
 */
void ModelSanity::rowsInserted(const QModelIndex & parent, int start, int end)
{
    /* prevent compiler warnings */ UNREFERENCED_PARAMETER (parent); UNREFERENCED_PARAMETER (start); UNREFERENCED_PARAMETER (end);
...
void ModelSanity::layoutAboutToBeChanged()
{
    for (int i = 0; i < qBound(0, model->rowCount(), 100); ++i)
        changing.append(QPersistentModelIndex(model->index(i, 0)));
}

void ModelSanity::layoutChanged()
{
...
/*!
    ...
    \sa rowsRemoved()
 */
void ModelSanity::rowsAboutToBeRemoved(const QModelIndex &parent, int start, int end)
{
    Changing c;
    c.parent = parent;
    c.oldSize = model->rowCount(parent);
 ...
 */
void ModelSanity::rowsRemoved(const QModelIndex & parent, int start, int end)
{
    /* prevent compiler warnings */ UNREFERENCED_PARAMETER (parent); UNREFERENCED_PARAMETER (start); UNREFERENCED_PARAMETER (end);
