...
report_formations (FILE *rf, SPWAW_SNAP_OOB_F *ptr)
{
	...
	for (i=0; i<ptr->cnt; i++) {
		...
		for (j=0; j<p->data.ucnt; j++) {
			q = p->data.ulist[j];
			fprintf (rf, "%-4s: %-3s %-32s %-16s %-16s %-4s %5u %6u %6.2f %% %3u\n",
				q->strings.uid, "", q->strings.status, q->data.tname, q->data.lname,
...
report_units (FILE *rf, SPWAW_SNAP_OOB_U *ptr)
{
	...
	fprintf (rf, "%s%s%s%s%s %-4s %-16s %-4s %-16s %5s %3s %3s %3s %3s %3s %3s %3s %3s %4s %4s %3s %3s %3s %8s %10s\n",
...
report_crews (FILE *rf, SPWAW_SNAP_OOB_U *ptr)
{
	...
	fprintf (rf, "%s%s%s%s%s %-4s %-16s %-4s %-16s %5s %3s %3s %3s %3s %3s %3s %3s %3s %4s %3s %3s %3s %8s %10s\n",
