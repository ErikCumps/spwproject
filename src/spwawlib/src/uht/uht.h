...
extern SPWAW_ERROR	UHT_battle_info	(SPWAW_UHT *uht, SPWAW_BATTLE *b, SPWAW_UHT_BINFO **info);

extern SPWAW_ERROR	UHT_update	(SPWAW_UHT *uht, SPWAW_BATTLE *b);
extern SPWAW_ERROR	UHT_rebuild	(SPWAW_UHT *uht);

extern void		UHT_debug_dump	(SPWAW_UHT *uht);
extern void		UHT_debug_dump	(SPWAW_UHT_BINFO *info);
