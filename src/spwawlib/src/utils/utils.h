...
#define	azstrcpy(src_, dst_)		aszstrcpy_core ((char *)src_, (char *)dst_, sizeof (dst_))
#define	azstrstab(src_, stab_)		aszstrstab_core ((char *)src_, sizeof (src_), stab_)
...
extern void	aszstrcpy_core		(char *src, char *dst, unsigned int size);
extern char *	aszstrstab_core		(char *src, unsigned int size, STRTAB *stab);
