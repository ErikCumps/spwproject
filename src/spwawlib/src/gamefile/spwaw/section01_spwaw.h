...
typedef struct s_SPWAW_ARMORST {
	SPWAW_ARMOR		HFront;			/* Hull front strength				*/
	SPWAW_ARMOR		HSide1;			/* Hull side1 strength				*/
	SPWAW_ARMOR		HSide2;			/* Hull side2 strength				*/
	SPWAW_ARMOR		HRear;			/* Hull rear strength				*/
	SPWAW_ARMOR		TFront;			/* Turret front strength			*/
	SPWAW_ARMOR		TSide1;			/* Turret side1 strength			*/
	SPWAW_ARMOR		TSide2;			/* Turret side2 strength			*/
	SPWAW_ARMOR		TRear;			/* Turret rear strength				*/
	SPWAW_ARMOR		TTop;			/* Turret top strength				*/
} SPWAW_ARMORST;

typedef struct s_SPWAW_ARMORSL {
...
typedef struct s_SPWAW_UNIT {
	...
	char			__data02[4];
	char			__data03[8];
	SPWAW_AMMO		wp0_ammo;		/* Unit slot0 weapon ammunition			*/
	SPWAW_AMMO		wp1_ammo;		/* Unit slot1 weapon ammunition			*/
	SPWAW_AMMO		wp2_ammo;		/* Unit slot2 weapon ammunition			*/
	SPWAW_AMMO		wp3_ammo;		/* Unit slot3 weapon ammunition			*/
	SPWAW_ARMORST		armor;			/* Unit armor strength				*/
	char			__data04[9];
	SPWAW_ARMORSL		slopes;			/* Unit armor slopes				*/
	char			__data05[3];
...
typedef struct s_SPWAW_SECTION01 {
	union u_u {
		...
		struct s_d {
			SPWAW_UNIT	units[SPWAW_UNITCOUNT];
		} d;
	} u;
} SPWAW_SECTION01;
