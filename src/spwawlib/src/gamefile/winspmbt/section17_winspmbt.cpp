...
static SPWAW_ERROR
add_unitpos (WINSPMBT_UNIT_POS *src, USHORT id, SPWAW_SNAP_OOB_PELRAW *dst, USHORT *idx)
{
...
SPWAW_ERROR
section17_winspmbt_save_snapshot (GAMEDATA *src, SPWAW_SNAPSHOT *dst, STRTAB * /*stab*/, FULIST &ful1, FULIST &ful2)
{
	SPWAW_ERROR		rc;
	WINSPMBT_UNIT_POS	*data;
	USHORT			idx;
	UEL			*p;

	CNULLARG (src); CNULLARG (dst);

	data = GDWINSPMBT(src)->sec17.u.d.pos;
